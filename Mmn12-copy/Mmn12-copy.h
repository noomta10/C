...
#define ENLARGE_SIZE(struct) (dynamic_array = realloc(dynamic_array.array_pointer, dynamic_array.size * INT_SIZE), dynamic_array.size++ )/* In order to add an int to the array */
